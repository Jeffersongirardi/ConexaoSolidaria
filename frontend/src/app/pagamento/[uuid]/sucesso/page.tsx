...
function SucessoConteudo({ uuid }: { uuid: string }) {
  ...
  return (
    <div className="mx-auto max-w-md text-center">
      ...
      <h1 className="mt-4 text-2xl font-bold">Obrigado pela sua doação!</h1>
      <p className="mt-2 text-gray-700">
        R$ {Number(pagamento.valor).toFixed(2)} via {pagamento.metodo} para {pagamento.instituicaoNome}.
      </p>
