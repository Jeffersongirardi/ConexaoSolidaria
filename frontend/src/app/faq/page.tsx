...
const itens = [
  ...
  ["Como as instituições são validadas?", "Toda instituição passa por análise de um administrador (CNPJ, dados e atuação) antes de publicar campanhas."],
  ...
  ["Posso doar valores em dinheiro?", "Sim, nas campanhas que aceitam contribuição financeira, via Pix, cartão ou transferência (simulação para fins do projeto piloto)."],
  ...
  ["Sou de uma instituição. Como participo?", "Cadastre a instituição na plataforma e aguarde a aprovação. Após aprovada, você pode publicar campanhas e gerenciar doações."],
];
